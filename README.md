...
&lt;p&gt; tag or one of the following tags: a &lt;li&gt;,&lt;div&gt;,&lt;ol&gt;,&lt;article&gt;,&lt;section&gt;,&lt;meta&gt;,&lt;a&gt;,or &lt;td&gt; tag. Generally, a large proportion of training cases (eg., 138 in figure 11) were classified as articles if their tag with the highest frequency count was a &lt;p&gt; tag and their main content node’s depth value was either 11,6,8,12,9,20,21,19, or 13 in the DOM tree. Conversely, a large proportion of training cases (eg., 94 in figure 11) were classified as non-articles if their tag with the highest frequency count was either a &lt;li&gt;,&lt;ol&gt;,&lt;article&gt;,&lt;section&gt;,&lt;meta&gt;,&lt;a&gt;,or&lt;td&gt; tag.

After examining the decision trees that were constructed for trial one it seems that the average depth value of the main content node was 13.14 (𝜎 = 5.23) for articles (based upon trial one's ten samples). This value was calculated by averaging together the values contained by the set that classified the largest proportion of training cases as articles when the most frequent HTML tag was a &lt;p&gt; tag (eg., in figure 11, this set would be {19, 9, 6, 11, 12,8, 13, 20, 21} since 138 training cases were classified as articles).

<a href="https://www.codecogs.com/eqnedit.php?latex=weightDepth*\frac{1}{x}&space;=\begin{cases}&space;x=1,&space;if&space;DOMtreeDepth\leq&space;14.60,&space;DOMtreeDepth\geq&space;11.68\\&space;x=\left&space;|DOMtreeDepth-13.14&space;\right&space;|,&space;if&space;DOMtreeDepth>14.60&space;\vee&space;DOMtreeDepth<&space;11.68&space;\\&space;\end{cases}" target="_blank"><img src="https://latex.codecogs.com/gif.latex?weightDepth*\frac{1}{x}&space;=\begin{cases}&space;x=1,&space;if&space;DOMtreeDepth\leq&space;14.60,&space;DOMtreeDepth\geq&space;11.68\\&space;x=\left&space;|DOMtreeDepth-13.14&space;\right&space;|,&space;if&space;DOMtreeDepth>14.60&space;\vee&space;DOMtreeDepth<&space;11.68&space;\\&space;\end{cases}" title="weightDepth*\frac{1}{x} =\begin{cases} x=1, if DOMtreeDepth\leq 14.60, DOMtreeDepth\geq 11.68\\ x=\left |DOMtreeDepth-13.14 \right |, if DOMtreeDepth>14.60 \vee DOMtreeDepth< 11.68 \\ \end{cases}" /></a>
...
After trying various different thresholds and weight values, I was unable to extract the first content chunk (ie., the article). To test the previous theory out (ie.,  regarding the scoring of nodes’ depth values in the DOM tree),  
a simple 60% confidence interval of 13.14![](https://github.com/kingjames24/super-duper-octo-goggles/blob/master/images/image17.png)1.46 was constructed from the previously calculated average depth value of 13.14 and standard deviation of 5.23. In constructing this confidence interval, levels greater than or equal to 90% were excluded since the critical t values at those levels were too high and would have resulted in a larger spread (however, levels less than 90% could have also been used). Constructing a larger spread did not make sense based upon the sample data,since figure 12 of sub-section 8.1 showed that most main content nodes' depth values in the DOM tree were located near one another. 
...
10. [20 trials of running link-target Id described by section 7 and sub-section 8.3](https://github.com/kingjames24/super-duper-octo-goggles/tree/master/PeformanceAccuracy_FineTunedModels/LinkTargetID)

11. [20 trials of running CoreEx described by section 7 and sub-section 8.2](https://github.com/kingjames24/super-duper-octo-goggles/tree/master/PeformanceAccuracy_FineTunedModels/CoreEx)

12. [20 trials of running link-target Id and CoreEx described by section 7 and sub-section 8.4](https://github.com/kingjames24/super-duper-octo-goggles/tree/master/PeformanceAccuracy_FineTunedModels/CoreEX%26LinkTargetID)

13. [Tuned decision trees constructed from the entire training set detailed by figure 11](https://github.com/kingjames24/super-duper-octo-goggles/tree/master/finalDecisionTrees_allTraingData_tunedOptions)
      * [link-target id](https://github.com/kingjames24/super-duper-octo-goggles/blob/master/finalDecisionTrees_allTraingData_tunedOptions/LinkTargetTree_windowing10_discreteGrouping.txt)
      * [CoreEx](https://github.com/kingjames24/super-duper-octo-goggles/blob/master/finalDecisionTrees_allTraingData_tunedOptions/CoreExTree_discreteGrouping.txt)
      * [link-target id and CoreEx](https://github.com/kingjames24/super-duper-octo-goggles/blob/master/finalDecisionTrees_allTraingData_tunedOptions/combinedTree_windowing10.txt)
     
14. [Decsion trees constructed from the entire training set using C4.5's default options(described by sub-section 8.4)](https://github.com/kingjames24/super-duper-octo-goggles/tree/master/finalDescionTrees_default)
      * [link-target id](https://github.com/kingjames24/super-duper-octo-goggles/blob/master/finalDescionTrees_default/default_link.txt)
      * [CoreEX](https://github.com/kingjames24/super-duper-octo-goggles/blob/master/finalDescionTrees_default/default_coreEx.txt)

15. [20 trials of running link-target Id with default options described by sub-section 8.5](https://github.com/kingjames24/super-duper-octo-goggles/tree/master/PerformanceAccuracy_DefaultModels/link-TargetID)

16. [20 trials of running CoreEx with default options described by sub-section 8.5](https://github.com/kingjames24/super-duper-octo-goggles/tree/master/PerformanceAccuracy_DefaultModels/CoreEX)
