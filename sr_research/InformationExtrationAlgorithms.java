...
/**
 * WARNING: This was the first implementation of link-target Identification and CoreEx. 
 * The new and improved implementation of CorexEx is found in the class IEA. This 
 * Class should not be run when doing data extraction. Rather IEA found in the package 
 * testingdifferentCoreEx forms should be run!!! This version is only saved for documentation
 * purposes. 
 * Adam Standke
 */
//package sr_research;
